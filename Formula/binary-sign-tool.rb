class BinarySignTool < Formula
  ...
  url "https://gitee.com/openharmony/developtools_hapsigner/repository/archive/OpenHarmony-v7.0-Beta1.tar.gz"
  sha256 "7b3e1ef1e9398ac3aa3d1b8c3cbbabaa3a27a0d62f3e1b7a3b3b1e3a1b3c3d3e"
  license "Apache-2.0"
  version "1.0.0"
  bottle do
    root_url "https://github.com/nknkol/harmonybrew-cask/releases/download/bottles%2Fbinary-sign-tool"
    sha256 cellar: :any_skip_relocation, arm64_ohos: "60a8d7b7b2ddb5c6e4398363b12f14d1c90979be66d2ffdfe997e668944b8dab"
  end
